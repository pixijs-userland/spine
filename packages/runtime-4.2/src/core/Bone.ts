...
import { IBone, MathUtils, Physics, TransformMode, Vector2 } from '@pixi-spine/base';
...
export class Bone implements Updatable, IBone {
    ...
    /** The local rotation in degrees, counterclockwise. */
    rotation = 0;
    ...
    updateWorldTransformWith(x: number, y: number, rotation: number, scaleX: number, scaleY: number, shearX: number, shearY: number) {
        ...
        switch (this.transformMode) {
            ...
            case TransformMode.NoRotationOrReflection: {
                const sx = 1 / this.skeleton.scaleX;
                const sy = 1 / this.skeleton.scaleY;
            ...
            case TransformMode.NoScaleOrReflection: {
                ...
                if (this.transformMode == TransformMode.NoScale && pa * pd - pb * pc < 0 != (this.skeleton.scaleX < 0 != this.skeleton.scaleY < 0)) s = -s;
    ...
    setToSetupPose() {
        ...
        this.transformMode = data.transformMode;
    }
    ...
    updateAppliedTransform() {
        ...
        if (this.transformMode == TransformMode.OnlyTranslation) {
            ra = this.a;
            rb = this.b;
            rc = this.c;
            rd = this.d;
            ...
            switch (this.transformMode) {
                ...
                case TransformMode.NoScaleOrReflection:
                    ...
                    if (this.transformMode == TransformMode.NoScale && pid < 0 != (this.skeleton.scaleX < 0 != this.skeleton.scaleY < 0)) s = -s;
                    const r = MathUtils.PI / 2 + Math.atan2(pc, pa);
